...
HOS mv &&orachk_orig_raw_file. &&orachk_obj_tabfile1.
...
HOS mv &&orachk_obj_tabfile1. &&orachk_orig_raw_file.

-- Expand reduced file.
HOS mv &&orachk_orig_red_file. &&orachk_obj_tabfile1.
...
HOS mv &&orachk_obj_tabfile1. &&orachk_orig_red_file.
