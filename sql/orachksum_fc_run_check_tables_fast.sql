...
-- Compare files.
HOS mv &&orachk_db_file.   &&orachk_obj_tabfile1.
HOS mv &&orachk_orig_file. &&orachk_obj_tabfile2.
...
HOS mv &&orachk_obj_tabfile1. &&orachk_db_file.
HOS mv &&orachk_obj_tabfile2. &&orachk_orig_file.
...
-- Compare files.
HOS cp &&orachk_orig_file. &&orachk_obj_tabfile1.
HOS cp &&orachk_db_file.   &&orachk_obj_tabfile2.
